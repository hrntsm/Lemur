...
{
    public class FistrElementListTests
    {
        [Fact]
        public void ConstructElementListTest()
        {
            var elementList = new FistrElementList(FistrElementType.Tetra341);
            Assert.Equal(FistrElementType.Tetra341, elementList.ElementType);
